...
# get user input for day of week (all, monday, tuesday, ... sunday)
    try:
        day = input("Which day? Please type your response as a string\
                    (e.g., Saturday).\n")
    except(ValueError, TypeError):
        print("Invalid input, please try again\n")
...
# filter by month if applicable
    if month != 'all':
        ...
        months = pd.Series(data=[i + 1 for i in range(len(months))],
                           index=months)
...
# display the most common day of week
    ...
    print("The Most Frequent Day of Week:\n", most_common_dow)
...
def station_stats(df):
    ...
    print("Most Common Start Station on Travel:\n", most_common_start_station)


# display most commonly used end station
    most_common_end_station = df['End Station'].mode()
    print("Most Common End Station on Travel:\n", most_common_end_station)
